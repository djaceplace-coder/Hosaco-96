  ...
  return (
    <PageWrapper>
      <div className="pt-32 pb-24 max-w-md mx-auto px-4 sm:px-6 min-h-screen flex items-center">
        <Card className="p-8 w-full shadow-xl">
          <h2 className="font-serif text-3xl font-semibold mb-2 text-center text-ink-navy">Reset Password</h2>
          <p className="text-center text-ink-navy/60 text-sm mb-8">Enter your email to receive a reset link.</p>
          ...
          {success ? (
            <div className="text-center">
              ...
              <p className="text-ink-navy/70 text-sm mb-6">We've sent password reset instructions to {email}.</p>
              <Link to="/login">
            ...
            <form onSubmit={handleReset} className="space-y-4">
              ...
              <div className="text-center mt-6 text-sm">
                <Link to="/login" className="text-harmattan-gold font-medium hover:underline">Back to Login</Link>
              </div>
            </form>
          )}
        </Card>
